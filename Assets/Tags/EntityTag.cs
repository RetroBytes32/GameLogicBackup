...
public class EntityTag : MonoBehaviour {
	...
	public bool   WalkSidewaysRight = false;
	...
	public bool   doWalkSideways  = false;
        ...
        if (isWalking) {
            ...
            if (isRunning) {
                ...
                if (doWalkSideways) {
                    ...
                    if (WalkSidewaysRight) {
                        controller.Move((transform.right * Speed * Time.deltaTime * SpeedMultiplier));
                    } else {
                        controller.Move(((-transform.right) * Speed * Time.deltaTime * SpeedMultiplier));
                    }
