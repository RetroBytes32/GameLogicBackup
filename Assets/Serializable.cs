...
public class WorldData {
	...
	public int[]     inv_stack       = new int[8];
	public int[]     inv_stackmax    = new int[8];
...
public class ChunkData {
    ...
    public long[]  ageSpan;
    public int[]   ageWhenBorn;
    public int[]   ageWhenAdult;
    public float[] ageSizeInc;
	...
	public ChunkData(int static_count, int dynamic_count) {
        ...
        masculine     = new bool[entityCount];
        ageSpan       = new long[entityCount];
        ageWhenBorn   = new int[entityCount];
        ageWhenAdult  = new int[entityCount];
        ageSizeInc    = new float[entityCount];
