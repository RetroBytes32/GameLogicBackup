...
public class ChunkSerializer {
	...
	public bool chunkSave() {
	  ...
	  // No save on load
	  //if (!chunkTag.isLoaded) return false;
	  ...
	  */
	  ...
	  for (int i = 0; i < entities.gameObject.transform.childCount; i++) {
	    ...
	    saveChunk.chanceChangeDirection[i]   = actorTag.chanceChangeDirection;
        ...
        saveChunk.consumtionTimer[i] = actorTag.consumtionTimer;
	...
	public void chunkFinalize() {
	  ...
	  for (int i=0; i < loadChunk.entityCount; i++) {
	    ...
	    // AI
	    actorTag.chanceChangeDirection = loadChunk.chanceChangeDirection[i];
        ...
        actorTag.consumtionTimer     = loadChunk.consumtionTimer[i];
	...
	public void saveWorldData() {
	  ...
	  worldData.sunAngle     = gameRulesObject.dayNightCycle;
	...
	public bool loadWorldData() {
	  ...
	  gameRulesObject.dayNightCycle   = worldData.sunAngle;
