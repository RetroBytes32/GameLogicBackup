...
public class Use : MonoBehaviour {
	...
	void Update () {
	  ...
	  string slotName = tickUpdate.hudInterface.inventory.checkSlot();
      ...
      if (Input.GetButtonDown("Use")) {
        ...
        // Check are we full
        if (tickUpdate.inventory.hunger == 10) {
        ...
        if (isConsuming) {
            ...
            if (useCounter == 1) {
                ...
                for (int i=0; i < tickUpdate.consumableItem.Length; i++) {
                    ...
                    tickUpdate.inventory.removeItem(tickUpdate.hudInterface.selectedSlot, 1);
                    tickUpdate.hudInterface.updateInHand();
                    
                    resetConsumeAnimation();
                    
                    if (tickUpdate.inventory.checkSlot() == "")
                        isConsuming = false;
	  ...
	  if (Input.GetButtonUp("Use")) {
	    ...
	    slotName = tickUpdate.inventory.checkSlot();
